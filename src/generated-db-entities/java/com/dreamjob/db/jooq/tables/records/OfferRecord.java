...
public class OfferRecord extends UpdatableRecordImpl<OfferRecord> implements Record8<Integer, Integer, Integer, BigDecimal, String, BigDecimal, LocalDateTime, LocalDateTime> {
     ...
     */
    public OfferRecord setPricePerUnit(BigDecimal value) {
        set(3, value);
        return this;
    }
    ...
    @Override
    public Row8<Integer, Integer, Integer, BigDecimal, String, BigDecimal, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    public Field<BigDecimal> field4() {
        return Offer.OFFER.PRICE_PER_UNIT;
    }
    ...
    @Override
    public OfferRecord value4(BigDecimal value) {
    ...
    @Override
    public OfferRecord value8(LocalDateTime value) {
        setUpdatedOn(value);
        return this;
    }

    @Override
    public OfferRecord values(Integer value1, Integer value2, Integer value3, BigDecimal value4, String value5, BigDecimal value6, LocalDateTime value7, LocalDateTime value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public OfferRecord(Integer id, Integer traderId, Integer professionId, BigDecimal pricePerUnit, String description, BigDecimal totalPrice, LocalDateTime createdOn, LocalDateTime updatedOn) {
        super(Offer.OFFER);
    ...
    public OfferRecord(com.dreamjob.db.jooq.tables.pojos.Offer value) {
        ...
        if (value != null) {
            ...
            setPricePerUnit(value.getPricePerUnit());
